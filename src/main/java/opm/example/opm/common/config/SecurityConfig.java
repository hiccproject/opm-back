                                ...
                                .authorizeHttpRequests(
                                                authorize -> authorize
                                                                ...
                                                                .requestMatchers(
                                                                                ...
                                                                                "/h2-console/**")
                                                                .permitAll()
                                                                .requestMatchers("/signup").hasRole("GUEST") // GUEST만
                                                                                                             // /signup
                                                                                                             // 접근 가능
                                                                .requestMatchers("/api/signup/consent").hasRole("GUEST") // 추가된
                                                                                                                         // 부분
                                                                                                                         // (GUEST만
                                                                                                                         // 동의
                                                                                                                         // API
                                                                                                                         // 호출
                                                                                                                         // 가능)
                                                                .requestMatchers("/s3/**").permitAll() // S3 이미지 업로드 접근
                                                                                                       // 허용
                                                                .requestMatchers("/api/portfolios/my").authenticated() // 내
                                                                                                                       // 목록은
                                                                                                                       // 인증
                                                                                                                       // 필수
                                                                .requestMatchers(HttpMethod.GET, "/api/portfolios/{id}")
                                                                .permitAll() // 상세 조회는 비회원 허용 예정
                                                                // 그 외 모든 요청은 인증 필요
                                                                .anyRequest()
                                                                .authenticated())
